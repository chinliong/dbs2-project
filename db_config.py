...
class DatabaseManager:
    ...
    def setup_indexes(self):
        """
        Create indexes for optimizing queries across collections
        """
        try:
            ...
            self.db.PatientHistory.create_index([("date", DESCENDING)])  # For sorting by latest
    ...
    def atomic_update_medication_quantity(self, medication_id, quantity_change):
        ...
        Returns True if update was successful, False if insufficient quantity
        """
        with self._connection_lock:
    ...
    def atomic_book_appointment(self, appointment_data):
        ...
        Returns True if booking was successful, False if slot is taken
        """
        with self._connection_lock:
